...
object CalorieCalculator {
    ...
    /**
     * Calculate calories burned during exercise using the improved MET formula
    ...
    fun calculateCaloriesBurned(
        ...
        val baseCalories = (metValue * userWeight * durationMinutes) / 60.0
     ...
     * Uses the improved MET formula for more accurate real-time calculations
     */
    ...
    /**
     * Calculate BMI using the standard formula: BMI = Weight(kg) / (Height(m) ^ 2)
     */
     ...
     * Updated to use the improved MET formula
     */
